    ...
    <div class="container">
        ...
        {{ Form::open(['route' => 'answers.store','method' => 'post', 'files' => true]) }}
            ...
            <div class="mb">
                ...
                {{ Form::text('answer1', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer2', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer3', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer4', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer5', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer6', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer7', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer8', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer9', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>
            <div class="mb">
                ...
                {{ Form::text('answer10', null, ['class'=>'form-control','maxlength'=>'30']) }}
            </div>


            {{ Form::submit('Terminar el parcial',['class' => 'btn btn-primary']) }}
        {!! Form::close() !!}
